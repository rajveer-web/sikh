...
<!-- end page -->
<div id="footer">
  <span class="style12"><a href="#" class="style13 style7">About us</a><span class="style7"> |</span> <a href="#" class="style13 style7">Contact us</a><span class="style7">  |</span> <a href="mem.php" class="style13 style7">Membership</a></span><?php include('link.php');?>
<p class="style6">
  <span style="color:#006633">Copyright © 2015. Design by </span class="style4" style="color:#006633" ><span class="style9 style7">rajveer ,pawan,navjot</span></p>
</div>
