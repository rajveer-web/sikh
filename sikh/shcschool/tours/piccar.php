...
<title>North India Tour and Travel</title>
</head>
...
<tr>
<td><a class="fancybox" style=" margin-left:5px;"  href="admin/photo/<?php echo $fetch['photo']; ?>" data-fancybox-group="gallery"><img width="300" height="250" style="margin-top:30px;" align="baseline" src="admin/photo/<?php echo $fetch['photo']; ?>"/></a></td>
