...
<div><table>
<div align="center" ><a class="style1"><strong>Religious Emblems</strong></a>  </div></table>
<?php 
@$id=$_GET['id'];
@$name= $_POST['name'];
@$desp=$_POST['desp'];
...
<td width="200"><a class="fancybox"   href="admin/images/<?php echo $info['photo']; ?>"  data-fancybox-group="gallery"><img src="admin/images/<?php echo $info['photo'];?> "width=200 height=200""  /></a></td>
